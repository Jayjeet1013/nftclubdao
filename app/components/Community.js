  ...
  return (
    <div className=" bg-gradient-to-b from-serviceColor to-black ">
      <div className="   max-w-screen-xl mx-auto pt-5 px-4">
        <div className="text-white justify-center text-center md:py-20">
          <h3 className="font-bold  text-3xl md:text-5xl ">
            Unlock Exclusive Community Perks
          </h3>
          <h6 className="text-2xl my-3">
            Our vision is to create high-class, utility-driven projects using
            the power of NFTs and communities.
          </h6>
        </div>
        <div className="flex flex-col md:flex-row gap-20 pb-8 text-white justify-center">
          <div className="w-100% md:w-96  text-center justify-center">
            <Image src={rewardimg} className="mx-auto" />
            <h2 className="text-bold text-2xl md:text-4xl ">
              Incentives & Rewards
            </h2>
            <p>
          ...
          <div className="w-100% md:w-96 justify-center text-center">
            <Image src={resourcesimg} className="mx-auto" />
            <h3 className="text-2xl md:text-4xl text-bold">
              Access to Resources
            </h3>
            <p>
        ...
        <div className="flex flex-col md:flex-row gap-20 md:pb-48 text-white justify-center">
          <div className="w-100% md:w-96 text-center justify-center">
        ...
        <div className="  border rounded-lg text-white ">
          <div
            className="p-6 md:p-28 text-center bg-cover"
            style={{ backgroundImage: 'url("/98.png")' }}
          >
            <h1 className="md:text-6xl text-3xl">Get Your Early Access!</h1>
            <p className="text-xl p-2">Become a part of a revolution.</p>
            <button className="rounded-lg border bg-violet-500 p-2 my-2">
              Join Discord
            </button>
          </div>
        </div>
        ...
        <div className="text-white text-center my-20 ">
          ...
          <p className="text-lg">
            We’re bringing our love for NFTs and communities together to create
            an NFT centred ecosystem filled with creativity and passion.
          </p>
        </div>

        <div className="flex flex-col md:flex-row gap-6  text-white  justify-center text-center ">
          <div className="  border  justify-between text-center rounded-lg flex-col gap-2 flex  py-20 w-100% px-4 ">
            <Image src={img_90} className="mx-auto" />
            <h3 className="text-3xl text-bold">Creative</h3>
            <p className="">
              Pushing boundaries and creating impact through creative output.
            </p>
          </div>
          <div className="border  rounded-lg justify-center text-center flex-col gap-2 flex py-20 w-100% px-4">
          ...
          <div className="border rounded-lg justify-center flex-col gap-2 flex text-center  py-20 w-100% px-4">
        ...
        <div className="text-center">
          <button className="rounded-lg bg-violet-600 p-2 my-12 ">
            Read More
          </button>
        </div>
