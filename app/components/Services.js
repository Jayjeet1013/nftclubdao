    ...
    <div className="bg-serviceColor">
      <div className=" max-w-screen-xl mx-auto px-4">
        <div className="text-white text-center p-4 md:p-8 ">
          <h1 className="text-xl md:text-5xl px-2 md:p-12 py-10">
            Discover our Unparalleled Services
          </h1>
          <p className="text-md ">
        ...
        <div className="flex text-center flex-col md:flex-row justify-center gap-4 pb-4 ">
          <div className="text-white border rounded text-center w-100% md:w-96 p-2 ">
        ...
        <Image src={bg_4} className="right-0 hiddenmobile absolute p-0 m-0 " />

        <div className="flex text-center flex-col md:flex-row justify-center gap-4">
          <div className="text-white border rounded text-center w-100% md:w-96 p-2 ">
        ...
        <div className="flex justify-center text-center p-4">
          <button className="border rounded-md bg-violet-800 p-1 m-4">
            Contact Us
          </button>
          <button className="border rounded-md text-white p-1 m-4">
            Explore More
          </button>
        </div>
